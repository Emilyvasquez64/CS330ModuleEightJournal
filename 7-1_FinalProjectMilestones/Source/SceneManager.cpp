...
void SceneManager::SetupSceneLights()
{
    ...
    m_pShaderManager->setVec3Value("directionalLight.ambient",  0.13f, 0.12f, 0.12f); // room scatter
    m_pShaderManager->setVec3Value("directionalLight.diffuse",  0.50f, 0.49f, 0.47f); // pulled back so white mug doesn't blow out
    ...
    m_pShaderManager->setVec3Value("pointLights[0].ambient",  0.04f, 0.03f, 0.03f);
    m_pShaderManager->setVec3Value("pointLights[0].diffuse",  0.25f, 0.24f, 0.23f);
    m_pShaderManager->setVec3Value("pointLights[0].specular", 0.06f, 0.06f, 0.05f);
    ...
    m_pShaderManager->setVec3Value("pointLights[2].diffuse",  0.16f, 0.16f, 0.15f);
    m_pShaderManager->setVec3Value("pointLights[2].specular", 0.06f, 0.06f, 0.06f);
    ...
    m_pShaderManager->setVec3Value("pointLights[3].ambient",  0.12f, 0.12f, 0.12f);
    m_pShaderManager->setVec3Value("pointLights[3].diffuse",  0.45f, 0.45f, 0.45f);
    m_pShaderManager->setVec3Value("pointLights[3].specular", 0.08f, 0.08f, 0.08f);
...
void SceneManager::RenderScene()
{
    ...
    /******************************************************************/
    {
        ...
        scaleXYZ    = glm::vec3(potRadius * 0.90f, 0.1f, potRadius * 0.90f);
        positionXYZ = glm::vec3(potCenterX, potTopY + 0.05f, potCenterZ);
        SetTransformations(scaleXYZ, 0, 0, 0, positionXYZ);
